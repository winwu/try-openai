...
prompt = f"""
Your task is to generate README.md file from the JavaScript React component \
which delimited by triple backticks, the readme file content must contains: \
* the description of the props and state in the component.
* introduce each functions and with the description of input and out.
* how is the usage.

in at most 500 words. 
